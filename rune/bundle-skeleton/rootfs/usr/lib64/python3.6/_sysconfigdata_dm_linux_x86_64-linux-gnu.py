...
build_time_vars = {'ABIFLAGS': 'dm',
 ...
 'LDFLAGS': '-Wl,-z,relro  -Wl,-z,now  -g',
 'LDLAST': '',
 'LDLIBRARY': 'libpython3.6dm.so',
 'LDLIBRARYDIR': '',
 'LDSHARED': 'gcc -pthread -shared -Wl,-z,relro  -Wl,-z,now  -g',
 'LDVERSION': '3.6dm',
 'LIBC': '',
 ...
 'PY_CFLAGS_NODIST': '-O2 -g -pipe -Wall -Werror=format-security '
                     ...
                     '-fPIC -fwrapv -flto -fuse-linker-plugin '
 ...
 'PY_CORE_CFLAGS': '-Wno-unused-result -Wsign-compare '
                   ...
                   '-grecord-gcc-switches   -m64 -mtune=generic '
                   '-fasynchronous-unwind-tables -fstack-clash-protection '
                   '-fcf-protection -D_GNU_SOURCE -fPIC -fwrapv  -Og -O2 -g '
 ...
 'PY_CPPFLAGS': '-IObjects -IInclude -IPython -I. '
                '-I/builddir/build/BUILD/Python-3.6.8/Include',
 'PY_FORMAT_SIZE_T': '"z"',
 'PY_LDFLAGS': '-Wl,-z,relro  -Wl,-z,now  -g',
